...
- 失敗時のデモ: [curved_training_collision.gif](./curved_training_collision.gif) を埋め込む予定
...
- [tiny_lidar_net_curved_circuit_epoch100.png](./tiny_lidar_net_curved_circuit_epoch100.png) を貼る
